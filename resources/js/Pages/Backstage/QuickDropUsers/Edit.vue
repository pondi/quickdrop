    ...
    <BackstageLayout>
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit QuickDrop User</h1>
                <Link
...
const form = useForm({
    ...
    email_verified: props.user.email_verified_at !== null,
});

const submit = () => {
    form.put(route('backstage.quickdrop-users.update', props.user.id));
};
</script>