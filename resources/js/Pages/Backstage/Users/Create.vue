    ...
    <BackstageLayout>
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Administrator</h1>
                <Link
                    :href="route('backstage.users.index')"
...
const submit = () => {
    form.post(route('backstage.users.store'));
};
</script>